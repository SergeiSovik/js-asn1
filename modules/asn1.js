...
class Stream {
	...
	constructor(enc, pos) {
		/** @type {*} */ this.enc;
		/** @type {number | undefined} */ this.pos;
	...
	parseTime(start, end, shortYear) {
		var s = this.parseStringISO(start, end),
			m = /** @type {Array<string | number>} */ ( (shortYear ? reTimeS : reTimeL).exec(s) );
		if (!m)
...
export class ASN1 {
	 ...
	 * @returns {string | null}
	 */
	content(maxLength) { // a preview of the content (intended for humans)
